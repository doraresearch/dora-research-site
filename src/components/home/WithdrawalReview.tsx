...
const stages: [string, string][] = [
  ...
  ['Data Assembly', 'KYC, transactions, gameplay, device intelligence, AML profile, bonus history, related accounts, support history.'],
  ['Agent Review', 'Payment Fraud, AML, Account Behavior, Identity, Account Linking, Case Synthesis Orchestrator.'],
  ['Policy Decision + Human Escalation', 'Low-risk cases resolve via operator-defined controls. Edge cases, AML triggers, KYC gaps, low-confidence recs route to a human analyst.'],
  ['Audit + Feedback', 'Evidence trail, player notification draft, SAR draft if needed, analyst override feedback, leadership reporting.'],
]
...
const orchestrator: [string, string] = [
  ...
  'Combines all specialist outputs into a composite risk score, recommended action, confidence level, reasoning chain, escalation status, and evidence-linked case package.',
]
    ...
    <section id="deployment-pattern" className="bg-base py-16 sm:py-20">
      <Container>
        ...
        <Reveal>
          ...
          <div className="mt-7 grid gap-8 lg:grid-cols-2 lg:gap-12">
            <div className="space-y-4 text-[17px] leading-[1.7] text-body">
              <p>
                High-value withdrawals are one of the highest-friction moments in gaming operations. Operators must decide whether to release, verify, hold, reject, refund, or escalate — based on payment history, KYC records, gameplay behavior, AML signals, device intelligence, related accounts, bonus history, support history, and prior fraud reviews.
              </p>
              <p className="font-semibold text-ink">DORA turns that manual investigation into a governed multi-agent review system.</p>
            </div>
            <div className="space-y-4 text-[16px] leading-[1.65] text-body">
              <p>
                When a withdrawal crosses an operator-defined threshold or matches predefined risk signals, DORA assembles the full case file and routes it through six specialist agents:{' '}
                <strong className="text-ink">Payment Fraud, AML / Source-of-Funds, Account Behavior, Identity Verification, Account Linking, and Case Synthesis.</strong>
              </p>
              <p>
                The system produces a policy-aware case package with a composite risk score, evidence-linked reasoning, recommended action, confidence level, draft player communication, escalation materials when required, and a complete audit trail.
              </p>
            </div>
          </div>

          {/* Trust callout */}
          <div className="mt-8 rounded-card border-l-4 border-deep-signal bg-signal-soft p-5">
            <p className="text-[15px] leading-[1.65] text-ink">
              <strong>DORA operates inside the operator&rsquo;s risk policy.</strong> Low-risk cases can be resolved through predefined controls, while edge cases, escalations, low-confidence recommendations, and compliance-sensitive decisions route to human review. <span className="font-semibold">DORA never auto-files regulatory reports.</span>
            </p>
          </div>
        </Reveal>
        ...
        <Reveal className="mt-10 rounded-card border border-line bg-soft p-6 sm:p-8">
          <p className="mb-3 font-mono text-[11px] uppercase tracking-[0.16em] text-deep-signal">
            Why this is agentic, not just rules or scoring
          </p>
          <div className="space-y-4 text-[15px] leading-[1.7] text-body">
            <p>
              Rules can trigger a review. Machine-learning models can score risk. DORA coordinates the work around the decision: gathering evidence, assigning specialist agents, reconciling domain findings, applying operator policy, routing low-risk cases through predefined controls, escalating uncertain or sensitive cases to humans, drafting operational outputs, preserving the audit trail, and learning from final decisions.
            </p>
            <p>
              DORA does not replace rules or machine-learning models. It orchestrates them.{' '}
              <strong className="text-ink">
                Rules define policy boundaries. ML models contribute risk and anomaly signals. DORA&rsquo;s agentic layer coordinates the investigation, synthesis, routing, documentation, escalation, and feedback loop required to turn those signals into controlled operational execution.
              </strong>
            </p>
          </div>
        </Reveal>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-card border border-line bg-white p-6">
              ...
              <p className="text-[14.5px] leading-[1.6] text-body">
                Senior fraud analysts spend <strong className="text-ink">15-45 minutes</strong> gathering data across payments, KYC, gameplay, support, device intelligence, AML systems, and related-account checks.
              </p>
            </div>
            <div className="relative overflow-hidden rounded-card border border-[#bfe9fb] bg-signal-soft p-6">
              ...
              <p className="text-[14.5px] leading-[1.6] text-ink">
                Coordinated agents assemble the case, score the risk, preserve the evidence, draft player communications, prepare AML escalation materials when needed, and route the case either through operator-defined policy or to a human analyst.
              </p>
            </div>
        ...
        <Reveal className="mt-12">
          <h3 className="text-[20px] font-bold leading-[1.2] text-ink sm:text-[24px]">
            Six specialist agents. <span className="text-muted">One policy-aware case package.</span>
          </h3>
          <div className="mt-6 overflow-hidden rounded-stage border border-[#1c2026] bg-[radial-gradient(120%_150%_at_50%_-10%,#161a22_0%,#0B0D11_62%)] p-5 shadow-[0_50px_90px_-55px_rgba(5,6,8,0.65)] sm:p-7">
            ...
            {/* Vertical connectors → orchestrator */}
        ...
        <Reveal className="mt-12">
          <h3 className="text-[20px] font-bold leading-[1.2] text-ink sm:text-[24px]">
            Designed for <span className="font-serif font-normal italic">governed automation</span> and human escalation.
          </h3>
        ...
        <Reveal className="mt-12">
          ...
          <p className="mt-3 font-mono text-[11px] italic text-muted">
            Pilot targets vary by operator volume, data availability, risk policy, automation permissions, and jurisdiction.
          </p>
        </Reveal>
      </Container>
    </section>
