...
const functions = ['Support', 'KYC', 'Payments', 'Risk', 'VIP', 'Compliance', 'Reporting']
      ...
      <Container className="pb-8 pt-20 text-center sm:pt-24">
        ...
        <div className="mt-7 animate-fade-up" style={{ animationDelay: '120ms' }}>
          <div className="relative mx-auto inline-block pl-7 text-left">
            ...
            <h1 className="max-w-[22ch] text-[44px] font-bold leading-[0.96] tracking-[-0.04em] text-ink sm:text-6xl lg:text-7xl xl:text-[78px]">
              The agent-native operations layer for <span className="font-serif font-normal italic">iGaming</span>
            </h1>
          </div>
        </div>
        ...
        <div className="animate-fade-up" style={{ animationDelay: '240ms' }}>
          <p className="mx-auto mt-7 max-w-[58ch] text-[18px] font-medium leading-[1.55] text-body sm:text-xl">
            DORA gives operators operational agents for core functions &mdash; helping them launch lean, operate safely, and scale without a traditional operations org.
          </p>
          <p className="mx-auto mt-3 max-w-[62ch] text-[15px] leading-[1.6] text-muted">
            Autonomous where safe. Human-controlled where it matters.
          </p>
          ...
          <p className="mx-auto mt-8 font-mono text-[10.5px] uppercase tracking-[0.18em] text-muted">
            {functions.join(' · ')}
          </p>
        </div>
      </Container>
