...
9. **How it works** (`#how-it-works`) — Aurora-ribbon stage: *Gather. Reason. Act. Escalate. Learn.* + five one-line definitions (collect context · apply rules · complete approved actions · route exceptions · improve playbooks and memory).
